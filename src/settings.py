...
class Settings:
    ...
    GROQ_TEAM_MODEL_ID = os.environ.get("GROQ_TEAM_MODEL_ID", "deepseek-r1-distill-llama-70b")
    GROQ_AGENT_MODEL_ID = os.environ.get("GROQ_AGENT_MODEL_ID", "qwen-2.5-32b")
    OPENROUTER_TEAM_MODEL_ID = os.environ.get("OPENROUTER_TEAM_MODEL_ID", "deepseek/deepseek-chat-v3-0324")
    OPENROUTER_AGENT_MODEL_ID = os.environ.get("OPENROUTER_AGENT_MODEL_ID", "deepseek/deepseek-r1")
    OLLAMA_TEAM_MODEL_ID = os.environ.get("OLLAMA_TEAM_MODEL_ID", "hf-tool-thinking-qween3-14b-32k:latest")
    OLLAMA_AGENT_MODEL_ID = os.environ.get("OLLAMA_AGENT_MODEL_ID", "hf-tool-thinking-qween3-14b-32k:latest")
